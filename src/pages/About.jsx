...
const AboutPage = () => {
    return (
        <div className="landing-container" style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem' }}>
            ...
            <section style={{ padding: '4rem 0', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '4rem', alignItems: 'center' }}>
                <motion.div
            ...
            <section style={{ padding: '6rem 0' }}>
                ...
                <div style={{ position: 'relative', maxWidth: '800px', margin: '0 auto' }}>
                    <div style={{ position: 'absolute', left: '50%', width: '2px', height: '100%', background: theme.colors.border, transform: 'translateX(-50%)' }}></div>
                    {[
                        ...
                        >
                            <div style={{ width: '45%', padding: '0 2rem' }}>
